...
$data modify storage uni:shop stock_temp_block set value "$(value)"

tellraw @a {storage: "uni:shop", nbt: "stock_temp_block"}
...
# clear
data remove storage uni:shop stock_temp_block
