...
scoreboard players set #zero _sub 0
...
# store to storage
execute store result storage uni:shop _up_temp.index int 1 run scoreboard players get #value _sub

function uni:shop/price/control/_up with storage uni:shop _up_temp
