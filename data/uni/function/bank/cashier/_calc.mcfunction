scoreboard players operation @s _cashier_bronze = @s _cashier_input
scoreboard players operation @s _cashier_gold = @s _cashier_input
...
# debug
# tellraw @a {score: {name: "@s", objective: "_cashier_input"}}
...
# clear
scoreboard players set @a _cashier_input 0
