...
# summon
$function uni:10key/summon_10key {rotate: $(rotate), function: "uni:bank/exchanger/exchange", up: "function uni:bank/exchanger/control/_up", down: "function uni:bank/exchanger/control/_down", mod: "return 0"}
